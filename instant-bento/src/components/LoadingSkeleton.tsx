    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-2 lg:col-span-2 lg:row-span-2">
          <div className="rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-sm border border-gray-100 dark:border-gray-700 h-full">
        ...
        <div className="md:col-span-1 lg:col-span-2 lg:row-span-1">
          <div className="rounded-2xl bg-white dark:bg-gray-800 p-6 shadow-sm border border-gray-100 dark:border-gray-700 h-full">
            <div className="animate-pulse">
